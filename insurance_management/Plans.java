...
class Term extends Input implements plan{
	...
	public void gain(int a[]) {
		...
		if(a[1] == 10) {
			...
			System.out.println("Your Total Investment for "+a[1]+"is"+((a[2]*12*a[1])));			
...
class Retirement extends Input{
	public Retirement() {
